...
<div class="grid grid-pad">
	...
	<div class="header col-1-1">
		<h1>ORANGE SKY</h1>
		<h2>Velkommen til den orange himmel. </h2>
		<h3>Oplev den spændende, hemmelige verden ved at oprette en bruger eller logge ind.</h3>
	</div>

	<div class="buttons col-1-1">
		<a id="a1" href="registrer.php"><button class="button1">Opret bruger</button></a>
		<a id="a2" href="login.php"><button class="button2">Log ind</button></a>
	</div>
